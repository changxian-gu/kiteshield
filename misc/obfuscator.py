...
def obfuscate_one_file(filename, variable_rename=False, whitespace_remove=False):
...
if __name__ == "__main__":
    ...
    whitespace_remove = False
    if (sys.argv[2] == "1"):
        variable_rename = True
    if (sys.argv[3] == "1"):
        whitespace_remove = True
    obfuscate_one_file(file_name, variable_rename, whitespace_remove)
